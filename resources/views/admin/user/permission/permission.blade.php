        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="row">
                        ...
                        <tbody>
                            ...
                            @foreach ($permission as $role) 
                                 <tr>
                                    ...
                                    <th scope="row"> {{$role->permission_name}} </th> 
                                    <th scope="row"> {{$role->permission_route}} </th> 
                                    <th scope="row"> 
                    ...
                    <div class="col-lg-4">
                        <form action=" {{url('admin/permission_store')}} " method="post">
                            @csrf
                            <div class="form-group">
                                <label for="permission_name">Permission Name </label>
                                <input id="permission_name" class="form-control" type="text" value="{{old('permission_name')}} " name="permission_name">
                            </div>
                            <div class="form-group">
                                <label for="permission_route">Permission Route </label>
                                <input id="permission_route" class="form-control" type="text" value="{{old('permission_route')}} " name="permission_route">
                            </div>
